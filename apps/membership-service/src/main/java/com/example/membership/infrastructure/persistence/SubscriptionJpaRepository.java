...
public interface SubscriptionJpaRepository extends JpaRepository<Subscription, String> {
    ...
    List<Subscription> findByAccountIdAndStatus(String accountId, SubscriptionStatus status);

    Optional<Subscription> findByAccountIdAndPlanLevelAndStatus(
    ...
    List<Subscription> findExpirable(@Param("status") SubscriptionStatus status,
